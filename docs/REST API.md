...
| URI                                                           | Resource                                                               | Type                  |                                                          GET                                                          |       PUT        |                  PATCH                   |      DELETE      |                   POST                   |
| ------------------------------------------------------------- | ---------------------------------------------------------------------- | --------------------- | :-------------------------------------------------------------------------------------------------------------------: | :--------------: | :--------------------------------------: | :--------------: | :--------------------------------------: |
| `/courses`                                                    | All courses                                                            | [Batching](#batching) | Administrator<br />Assistants (only related ones)<br />Students (only related ones)<br />Teachers (only related ones) |  Administrator   |              Administrator               |       :x:        |            ~~Administrator~~             |
| `/courses/:courseID`                                          | The course                                                             | [Resource](#resource) |                   Administrator<br />Related Assistants<br />Related Students<br />Related Teachers                   |  Administrator   |              Administrator               |  Administrator   |                   :x:                    |
| `/courses/:courseID/assistants`                               | The set of primary keys of users who assists the course                | [Key Set](#key-set)   |                            Related Assistants<br />Related Students<br />Related Teachers                             | Related Teachers |             Related Teachers             |       :x:        |                   :x:                    |
| `/courses/:courseID/students`                                 | The set of primary keys of students who take the course                | [Key Set](#key-set)   |                   Administrator<br />Related Assistants<br />Related Students<br />Related Teachers                   |  Administrator   |              Administrator               |       :x:        |                   :x:                    |
| `/courses/:courseID/tasks`                                    | All tasks which the course assigns                                     | [Batching](#batching) |                            Related Assistants<br />Related Students<br />Related Teachers                             | Related Teachers |             Related Teachers             |       :x:        |             Related Teachers             |
| `/courses/:courseID/tasks/:taskID`                            | The task which the course assigns                                      | [Resource](#resource) |                            Related Assistants<br />Related Students<br />Related Teachers                             | Related Teachers |             Related Teachers             | Related Teachers |                   :x:                    |
...
| `/courses/:courseID/tasks/:taskID/homeworks`                  | All homeworks of the task which the course assigns                     | [Batching](#batching) |                            Related Assistants<br />Related Students<br />Related Teachers                             |       :x:        | Related Assistants<br />Related Teachers |       :x:        | Related Assistants<br />Related Teachers |
| `/courses/:courseID/tasks/:taskID/homeworks/:homeworkID`      | The homework of the task which the course assigns for the student      | [Resource](#resource) |                               Related Assistants<br />Related Teachers<br />The Student                               |       :x:        | Related Assistants<br />Related Teachers |       :x:        |                   :x:                    |
| `/courses/:courseID/tasks/:taskID/homeworks/:homeworkID/file` | The homework file of the task which the course assigns for the student | File                  |                                           Related Teachers<br />The Student                                           |   The Student    |                   :x:                    | Related Teachers |                   :x:                    |
| `/courses/:courseID/teachers`                                 | The set of primary keys of teachers who teach the course               | [Key Set](#key-set)   |                   Administrator<br />Related Assistants<br />Related Students<br />Related Teachers                   |  Administrator   |              Administrator               |       :x:        |                   :x:                    |
